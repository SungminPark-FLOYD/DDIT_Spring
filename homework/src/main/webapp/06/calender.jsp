...
function submitForm(direction, e) {
	e.preventDefault(); 
	...
	} else if (direction === "nextM") {
	  monthInput.value = parseInt(monthInput.value) + 1;
	}
	
	if (direction === "prevY") {
		yearInput.value = parseInt(yearInput.value) - 1;
	} else if (direction === "nextY") {
		yearInput.value = parseInt(yearInput.value) + 1;
	}
...
function changeLanguage() {
    const form = document.forms["languageForm"];
...
<body>
<form action="<%=request.getContextPath() %>/changeLanguage" method="post" name="languageForm">
...
<div class="calendar">
	<div class="title">
		<form action="<%=request.getContextPath() %>/06/calender.jsp" method="post" name="ff">
		  <input type="hidden" name="year" value="<%=year%>">
		  <input type="hidden" name="month" value="<%=month%>">
		</form>
		
		<a href="./calender.jsp" onclick="submitForm('prevY', event)">&lt;&lt;</a>
		<a href="./calender.jsp" onclick="submitForm('prevM', event)">&lt;</a>
		<label><%=year%>년 <%=month%>월</label>
		<a href="./calender.jsp" onclick="submitForm('nextM', event)">&gt;</a>
		<a href="./calender.jsp" onclick="submitForm('nextY', event)">&gt;&gt;</a>
		<br>
